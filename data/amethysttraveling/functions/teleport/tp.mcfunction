...
execute as @e[type=!#not_teleportable,tag=!TpPlatform,nbt=!{Marker: 1b},distance=..1.6] run function amethysttraveling:teleport/tp_entity
...
execute unless entity @e[tag=TpPlatform,scores={AT.selected=1}] as @e[tag=TpPlatform,distance=..1.5,sort=nearest,limit=1] at @s run function amethysttraveling:platform/unlink
