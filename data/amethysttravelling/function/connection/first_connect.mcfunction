...
execute store result score @s AT.targetId run scoreboard players get @e[tag=fast_travel_point,sort=nearest,limit=1] AT.id

# set connecting
scoreboard players set @s AT.isConnecting 1
scoreboard players set @e[tag=fast_travel_point,distance=..1.5,sort=nearest,limit=1] AT.isConnecting 1
