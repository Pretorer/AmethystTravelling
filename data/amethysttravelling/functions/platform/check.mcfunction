...
execute as @e[tag=fast_travel_point,scores={AT.level=1,AT.dimension=17}] at @s unless entity @p[distance=..1.5] run scoreboard players set @s AT.isIntact 0
execute as @e[tag=fast_travel_point,scores={AT.level=1,AT.dimension=20}] at @s unless entity @p[distance=..1.5] run scoreboard players set @s AT.isIntact 0
execute as @e[tag=fast_travel_point,scores={AT.level=2,AT.dimension=17}] at @s unless entity @p[distance=..1.5] run scoreboard players set @s AT.isIntact 0
