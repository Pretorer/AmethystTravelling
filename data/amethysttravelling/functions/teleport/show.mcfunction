...
execute at @a[scores={AT.relChannTime=1..}] run particle minecraft:enchant ~ ~0.4 ~ 0.3 0.9 0.3 0.5 6 normal @a[scores={AT.moreParticles=0}]
execute at @a[scores={AT.relChannTime=1}] run particle minecraft:enchant ~ ~0.4 ~ 0.3 0.9 0.3 0.5 4 normal @a[scores={AT.moreParticles=1..}]
execute at @a[scores={AT.relChannTime=2}] run particle minecraft:enchant ~ ~0.4 ~ 0.3 0.9 0.3 0.5 8 normal @a[scores={AT.moreParticles=1..}]
execute at @a[scores={AT.relChannTime=3}] run particle minecraft:enchant ~ ~0.4 ~ 0.3 0.9 0.3 0.5 16 normal @a[scores={AT.moreParticles=1..}]
execute at @a[scores={AT.relChannTime=4}] run particle minecraft:enchant ~ ~0.4 ~ 0.3 0.9 0.3 0.5 32 normal @a[scores={AT.moreParticles=1..}]
execute at @a[scores={AT.relChannTime=5}] run particle minecraft:enchant ~ ~0.4 ~ 0.3 0.9 0.3 0.5 64 normal @a[scores={AT.moreParticles=1..}]
execute at @a[scores={AT.relChannTime=6}] run particle minecraft:enchant ~ ~0.4 ~ 0.3 0.9 0.3 0.5 128 normal @a[scores={AT.moreParticles=1..}]
execute at @a[scores={AT.relChannTime=7}] run particle minecraft:enchant ~ ~0.4 ~ 0.3 0.9 0.3 0.5 256 normal @a[scores={AT.moreParticles=1..}]
execute at @a[scores={AT.relChannTime=8}] run particle minecraft:enchant ~ ~0.4 ~ 0.3 0.9 0.3 0.5 512 normal @a[scores={AT.moreParticles=1..}]
execute at @a[scores={AT.relChannTime=9}] run particle minecraft:enchant ~ ~0.4 ~ 0.3 0.9 0.3 0.5 1024 normal @a[scores={AT.moreParticles=1..}]
execute at @a[scores={AT.relChannTime=10}] run particle minecraft:enchant ~ ~0.4 ~ 0.3 0.9 0.3 0.5 2048 normal @a[scores={AT.moreParticles=1..}]
...
execute at @e[tag=fast_travel_point,scores={AT.relChannTime=1..}] run particle minecraft:enchant ~ ~0.4 ~ 0.3 0.9 0.3 0.5 6 normal @a[scores={AT.moreParticles=0}]
execute at @e[tag=fast_travel_point,scores={AT.relChannTime=1}] run particle minecraft:enchant ~ ~0.4 ~ 0.3 0.9 0.3 0.5 4 normal @a[scores={AT.moreParticles=1..}]
execute at @e[tag=fast_travel_point,scores={AT.relChannTime=2}] run particle minecraft:enchant ~ ~0.4 ~ 0.3 0.9 0.3 0.5 8 normal @a[scores={AT.moreParticles=1..}]
execute at @e[tag=fast_travel_point,scores={AT.relChannTime=3}] run particle minecraft:enchant ~ ~0.4 ~ 0.3 0.9 0.3 0.5 16 normal @a[scores={AT.moreParticles=1..}]
execute at @e[tag=fast_travel_point,scores={AT.relChannTime=4}] run particle minecraft:enchant ~ ~0.4 ~ 0.3 0.9 0.3 0.5 32 normal @a[scores={AT.moreParticles=1..}]
execute at @e[tag=fast_travel_point,scores={AT.relChannTime=5}] run particle minecraft:enchant ~ ~0.4 ~ 0.3 0.9 0.3 0.5 64 normal @a[scores={AT.moreParticles=1..}]
execute at @e[tag=fast_travel_point,scores={AT.relChannTime=6}] run particle minecraft:enchant ~ ~0.4 ~ 0.3 0.9 0.3 0.5 128 normal @a[scores={AT.moreParticles=1..}]
execute at @e[tag=fast_travel_point,scores={AT.relChannTime=7}] run particle minecraft:enchant ~ ~0.4 ~ 0.3 0.9 0.3 0.5 256 normal @a[scores={AT.moreParticles=1..}]
execute at @e[tag=fast_travel_point,scores={AT.relChannTime=8}] run particle minecraft:enchant ~ ~0.4 ~ 0.3 0.9 0.3 0.5 512 normal @a[scores={AT.moreParticles=1..}]
execute at @e[tag=fast_travel_point,scores={AT.relChannTime=9}] run particle minecraft:enchant ~ ~0.4 ~ 0.3 0.9 0.3 0.5 1024 normal @a[scores={AT.moreParticles=1..}]
execute at @e[tag=fast_travel_point,scores={AT.relChannTime=10}] run particle minecraft:enchant ~ ~0.4 ~ 0.3 0.9 0.3 0.5 2048 normal @a[scores={AT.moreParticles=1..}]
