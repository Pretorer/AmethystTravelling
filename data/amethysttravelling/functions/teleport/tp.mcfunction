...
execute unless entity @e[tag=TpPlatform,scores={AT.selected=1}] as @e[tag=TpPlatform,distance=..1.5,sort=nearest,limit=1] at @s run function amethysttravelling:platform/unlink
