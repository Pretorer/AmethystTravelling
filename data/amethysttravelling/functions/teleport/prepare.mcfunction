...
execute as @a[scores={AT.channelTime=1..}] at @s unless entity @e[tag=fast_travel_point,scores={AT.isConnected=1},distance=..1.5] run function amethysttravelling:teleport/stop_channelling
execute as @a[scores={AT.channelTime=1..}] at @s unless entity @s[predicate=amethysttravelling:has_magical_item] run function amethysttravelling:teleport/stop_channelling
